...
void printTable(int num) {
    ...
    for (int i = 1; i <= 12; i++) {
        cout << num << "  x  " << setw(2) << left << i << "  =  " << (num * i) << "\n";
    }
}

// Part B: Print multiplication tables from 1 to N, separated by a line
...
int main() {
    ...
    // Part A: table for just the entered number
    printTable(n);

    cout << "\n---------------------------\n";
    cout << "Bonus: Tables from 1 to " << n << "\n";
    cout << "---------------------------\n";
